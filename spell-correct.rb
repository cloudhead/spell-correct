...
def edit word
    ...
    (0...n).collect       {|i| word[0...i] + word[i + 1..-1] } +                                            # Deletion
    ...
    (n + 1).times.collect {|i| LETTERS.collect {|l| word[0...i] + l.chr + word[i..-1] } }.flatten           # Insertion  
end

def edit2 word
    edit( word ).collect {|e| known edit(e) }.compact 
end
